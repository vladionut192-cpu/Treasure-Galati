// Heritage Galați — main JavaScript (core).
// Refactor 2026-06-02: setup-ul independent (local-dev, i18n picker, onboarding,
// service-worker) a fost mutat în js/boot.js, care se încarcă ÎNAINTE de acest
// fișier. Tot ce e mai jos trăiește într-un singur IIFE async care încarcă datele
// (locations/cartiere/tours/...) și apoi inițializează harta și UI-ul.
//
// CUPRINS (caută separatorul `─── <nume> ───` pentru a sări la secțiune):
//   • Cartiere overlay (Voronoi polygons)
//   • Filter & timeline state
//   • Search: Fuse.js fuzzy + fallback substring
//   • Lightbox: gallery mode
//   • Filter chips / Timeline slider
//   • Flags by political entity
//   • Historic map overlay (multi-layer eHarta)
//   • Valul lui Traian / Granița administrativă istorică (overlays)
//   • Desktop layer bubbles
//   • „Galați de altădată" — fotografii istorice + lightbox navigation
//   • „Știați că?" — curiozități pe hartă
//   • Deep links: ?loc / ?tour / ?hunt
//   • Tabs / Tour browse list / Treasure Hunts
//   • Verify location modal / Runtime overflow guard
//   • Top nav + Mobile topbar/portal
//   • Events page / Comic reader 1918
//   • Add-pin tool / Before-After / Add-photo tool
